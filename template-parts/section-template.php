...
<?php if ($section->have_posts()) : ?>
    ...
    <section class="container mx-auto my-12 px-10">
        ...
        <div class="flex flex-col justify-start my-2">
            ...
            <div class="flex items-center justify-center">
                <img class="my-2 w-full lg:w-[70%]" src="<?php echo esc_url(get_field("paragraph-image-1")["url"]); ?>" alt="">
            </div>
            <?php endif; ?>
        </div>
        <!-- /paragraph 1 -->
        ...
        <!-- paragraph2 -->
        <div class="flex flex-col justify-start my-2 mt-20">
            ...
            <div class="flex items-center justify-center">
                <img class="my-2 w-full lg:w-[70%]" src="<?php echo esc_url(get_field("paragraph-image-2")["url"]); ?>" alt="">
            </div>
            <?php endif; ?>
        </div>
        <!-- /paragraph 2 -->
        ...
        <div class="flex flex-col justify-start my-2 mt-20">
            ...
            <div class="flex items-center justify-center">
                <img class="my-2 w-full lg:w-[70%]" src="<?php echo esc_url(get_field("paragraph-image-3")["url"]); ?>" alt="">
            </div>
            <?php endif; ?>
        </div>
        <!-- /paragraph 3 -->
        ...
        <div class="flex flex-col justify-start my-2 mt-20">
            ...
            <div class="flex items-center justify-center">
                <img class="my-2 w-full lg:w-[70%]" src="<?php echo esc_url(get_field("paragraph-image-4")["url"]); ?>" alt="">
            </div>
            <?php endif; ?>
        </div>
        <!-- /paragraph 4 -->
